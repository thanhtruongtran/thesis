...
from src.services.core.token_anomal_change_ranking import (
    TokenChangeRankingService,
)


class TokenChangeRankingJob(SchedulerJob):
    def __init__(
        self,
        run_now,
        delay,
